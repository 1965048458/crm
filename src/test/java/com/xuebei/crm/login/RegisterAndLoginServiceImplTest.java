...
//
//    @Mock
//    private LoginRegisterMapper registerAndLoginMapper;
//
//    @Test
...
//        user.setTel(tel);
//
//        when(registerAndLoginMapper.searchTel(tel)).thenReturn(user);
//
//        User users = registerAndLoginService.searchTel(tel);
//
